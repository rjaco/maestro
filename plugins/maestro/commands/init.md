...
_(No flags — init is interactive. It asks for a project description, scans the codebase, previews the inferred DNA, and confirms before writing files.)_
...
Re-initialize (regenerate DNA for an existing project):

```
/maestro init
```

_(If `.maestro/dna.md` already exists, init asks whether to regenerate or cancel.)_

## See Also

- `/maestro doctor` — Verify installation health after init
- `/maestro config` — View or edit generated configuration
- `/maestro` — Start building once initialized
