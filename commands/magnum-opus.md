...
**This command is invoked as `/maestro magnum-opus` or `/magnum-opus`. The old `/maestro magnum-opus` redirects here.**
...
2. If no active Opus session exists:
   ...
   Start a new one: /maestro magnum-opus "Your product vision"
   ```
   Stop here.
...
Usage:
  /maestro magnum-opus "Build a SaaS analytics dashboard"
  /maestro magnum-opus "Improve this project continuously"
...
**Why this matters:** The user runs `/maestro magnum-opus` expecting autonomous
